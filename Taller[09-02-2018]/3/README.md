...
1. Si la función es continua en un intervalo [a,b], su imagen está dentro del intervalo [a,b], para todo x en el intervalo [a,b]. Entonces existe una solución para `g(x) = x`.
...
Esto quiere decir que la función tiene una solución a `g(x) = x` si el intervalo tomado contiene a `k^(1/2)`.
